...
public class UpdateProjectTranslationDtoValidator : AbstractValidator<UpdateProjectTranslationDto>
{
    public UpdateProjectTranslationDtoValidator(IStringLocalizer<SharedResource> localizer)
    {
