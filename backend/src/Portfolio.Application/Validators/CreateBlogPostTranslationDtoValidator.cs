...
public class CreateBlogPostTranslationDtoValidator : AbstractValidator<CreateBlogPostTranslationDto>
{
    public CreateBlogPostTranslationDtoValidator(IStringLocalizer<SharedResource> localizer)
    {
